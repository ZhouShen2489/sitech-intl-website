...
function ActionLink({
  ...
  const className =
    variant === "primary"
      ? "inline-flex rounded-full bg-ink px-5 py-3 text-sm font-semibold text-white transition hover:bg-slate"
      : "inline-flex rounded-full border border-ink px-5 py-3 text-sm font-semibold text-ink transition hover:bg-ink hover:text-white";
    ...
    <>
      ...
      <section className="bg-white py-20 lg:py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mt-10 rounded-[2.5rem] border border-slate-200 bg-[#f7f9fb] p-8 shadow-card lg:p-10">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mt-10 grid gap-6">
            {detail.familyItems.map((item) => (
              <article
                key={item.title.en}
                className="grid gap-8 rounded-[2.5rem] border border-slate-200 bg-white p-8 shadow-card lg:grid-cols-[1.05fr_0.95fr]"
              >
                <div>
